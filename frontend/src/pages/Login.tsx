    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 border border-slate-100">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-500 mt-2 text-center">Sign in to your account to manage your support tickets</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            ...
            disabled={loading}
            className={clsx(
              "w-full py-3 px-4 rounded-xl text-white font-medium transition-all focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2",
